...
## Workshop/course documentation template

Use the workshop-report template to document a particular occasion on which an adapted card set was used. Mandatory information is marked with an asterisk.
...
A fill in Word template can be found for download here: [documentation of workshop/course](workshop-report-template.docx)