...
1. Define the system or question the card set will address.
2. Decide which categories of cards are needed.
3. Duplicate the relevant card layouts in the editable template.
4. Add a concise term or concept to each card.
5. Adjust colours, icons, or categories where necessary.
