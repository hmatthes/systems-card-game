...
This adaptation is a mapping tool for the operational environment of being a scientist. Cards are broad, so they can be used to describe the system in different career stages with one tool.
...
We used four different categories for cards: **Conditions for participation:** Who can be part of science, and under what circumstances?, **Rules and recognition:** How is science governed, judged, valued, and legitimized?, **Scientific work practices:** What do scientists actually do, and how? and **Competition and access:** What do scientists need, and who gets access to it?

## Languages 

This card set is available in English.
...
The adapted card set is available in English.
