...
The workshop used the **Reindeer Herding as a Livelihood** card set, also described as the *Operational Environment of Reindeer Husbandry* deck.

[Read the card-set documentation]({{ site.baseurl }}/applications/reindeer-herding/adaptation/)
...
No event-specific changes to the method were recorded in the source documentation.

<!--
Information still needed: Were any changes made to the cards, facilitation,
timing or group composition for this event? What would the organisers change
if they repeated the workshop?
-->
